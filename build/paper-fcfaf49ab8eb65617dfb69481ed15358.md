...
* <xref:mriscope#fig1stat> 
* <xref:mriscope#fig1> 
* <xref:mriscope#fig2>
* <xref:mriscope#fig5>

::::{dropdown} An interactive figure embedded from another article using MyST cross-reference syntax
:::{embed} xref:mriscope#fig1

A figure embedded from another article using the MyST cross-reference syntax.
:::
...
### From your paper into my paper - The NeuroxLink way
